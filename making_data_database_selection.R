...
datx$cigday_mom<-with(datx,ifelse(cigday_na_mom==0,cigday_mom,NA))
datx$agesmk_mom<-with(datx,ifelse(agesmk_na_mom==0,agesmk_mom,NA))
datx$smkces_mom<-with(datx,ifelse(smkces_na_mom==0,smkces_mom,NA))
